...
\newpage
\appendix
\section{Training Details (Algorithm 1)}
...
\textbf{ImageNet-64.} 32K KAN-EBM reaches 25.05 dB; 13.1M FFN-DSM achieves 18.19 dB on the same task (the FFN result is single-pass, no iterative scaling possible).
